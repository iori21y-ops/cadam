...
export const VEHICLE_LIST: Vehicle[] = [
  ...
  { id: 'g06', brand: '제네시스', model: 'GV80', slug: 'gv80', category: 'SUV', segment: '대형 SUV', fuel: '가솔린', imageKey: 'genesis-gv80', has360Spin: true, frameCount: 80, spinStartFrame: 9, trims: ['2.5T', '2.5T AWD', '3.5T', '3.5T AWD'], seoTitle: 'GV80 장기렌트 | 월 납부금 비교', seoDescription: '제네시스 GV80 장기렌터카. 대형 SUV 장기렌트 최저가 견적.' },
  { id: 'g07', brand: '제네시스', model: 'GV80 쿠페', slug: 'gv80-coupe', category: 'SUV', segment: '대형 SUV 쿠페', fuel: '가솔린', imageKey: 'genesis-gv80-coupe', has360Spin: true, frameCount: 72, spinStartFrame: 8, trims: ['2.5T', '3.5T', '3.5T AWD'], seoTitle: 'GV80 쿠페 장기렌트 | 월 납부금 비교', seoDescription: '제네시스 GV80 쿠페 장기렌터카. 프리미엄 SUV 쿠페 장기렌트 견적.' },
  ...
  // 르노코리아 (10종)
  // ═══════════════════════════════════
  { id: 'rk01', brand: '르노코리아', model: 'QM6', slug: 'qm6', category: 'SUV', segment: '중형 SUV', fuel: '가솔린/LPG', imageKey: 'renault-qm6', has360Spin: true, frameCount: 72, spinStartFrame: 8, trims: ['LE', 'RE', 'RE 시그니처'], seoTitle: 'QM6 장기렌트 | 월 납부금 비교', seoDescription: '르노코리아 QM6 장기렌터카. 중형 SUV 가솔린·LPG 장기렌트 견적을 확인하세요.' },
  { id: 'rk02', brand: '르노코리아', model: 'XM3', slug: 'xm3', category: 'SUV', segment: '소형 SUV', fuel: '가솔린', imageKey: 'renault-xm3', has360Spin: true, frameCount: 72, spinStartFrame: 8, trims: ['LE', 'RE', 'RE 오라'], seoTitle: 'XM3 장기렌트 | 월 납부금 비교', seoDescription: '르노코리아 XM3 장기렌터카. 감각적인 소형 SUV 장기렌트 견적.' },
  ...
  { id: 'rk04', brand: '르노코리아', model: '아르카나 하이브리드', slug: 'arkana', category: 'SUV', segment: '소형 SUV 쿠페', fuel: '하이브리드', imageKey: 'renault-arkana', has360Spin: true, frameCount: 72, spinStartFrame: 8, trims: ['아이코닉'], seoTitle: '아르카나 하이브리드 장기렌트 | 월 납부금 비교', seoDescription: '르노코리아 아르카나 E-Tech 하이브리드 장기렌터카. 스타일리시한 쿠페형 SUV 장기렌트 견적.' },
  ...
  { id: 'rk07', brand: '르노코리아', model: '그랑 콜레오스', slug: 'grand-koleos', category: 'SUV', segment: '중형 SUV', fuel: '가솔린', imageKey: 'renault-grand-koleos', has360Spin: true, frameCount: 72, spinStartFrame: 8, trims: ['테크노', '아이코닉', '에스프리 알핀', '아이코닉 4WD', '에스카파드', '에스카파드 4WD'], seoTitle: '그랑 콜레오스 장기렌트 | 월 납부금 비교', seoDescription: '르노코리아 그랑 콜레오스 가솔린 장기렌터카. 중형 SUV 장기렌트 트림별 최저가 견적.' },
  ...
  { id: 'rk09', brand: '르노코리아', model: '필랑트', slug: 'filante', category: '세단', segment: '대형 세단', fuel: '하이브리드', imageKey: 'renault-filante', has360Spin: true, frameCount: 72, spinStartFrame: 8, trims: ['테크노', '아이코닉', 'SE', '에스프리 알핀'], seoTitle: '필랑트 장기렌트 | 월 납부금 비교', seoDescription: '르노코리아 필랑트 E-Tech 하이브리드 장기렌터카. 프리미엄 대형 세단 장기렌트 견적.' },
  { id: 'rk10', brand: '르노코리아', model: 'SM6', slug: 'sm6', category: '세단', segment: '중형 세단', fuel: '가솔린', imageKey: 'renault-sm6', has360Spin: true, frameCount: 72, spinStartFrame: 8, trims: ['인스파이어'], seoTitle: 'SM6 장기렌트 | 월 납부금 비교', seoDescription: '르노코리아 SM6 TCe 300 장기렌터카. 감성 중형 세단 장기렌트 최저가 견적.' },

  // ═══════════════════════════════════
  // KGM (12종)
  // ═══════════════════════════════════
  { id: 'kg01', brand: 'KGM', model: '더 뉴 티볼리 1.6 가솔린', slug: 'tivoli', category: 'SUV', segment: '소형 SUV', fuel: '가솔린', imageKey: 'kgm-tivoli', has360Spin: true, frameCount: 36, spinStartFrame: 4, trims: ['스마트', '퍼펙트'], seoTitle: '티볼리 장기렌트 | 월 납부금 비교', seoDescription: 'KGM 티볼리 장기렌터카. 소형 SUV 장기렌트 최저가 견적을 확인하세요.' },
  ...
  { id: 'au02', brand: '아우디', model: 'A5',       slug: 'audi-a5',       category: '세단', segment: '중형 세단',         fuel: '가솔린',     imageKey: 'audi-a5',       trims: ['40 TFSI Advanced', '40 TFSI S-line', '45 TFSI quattro S-line'], seoTitle: '아우디 A5 장기렌트 | 월 납부금 비교', seoDescription: '아우디 A5 장기렌터카 견적. 프리미엄 중형 세단 장기렌트 조건을 비교하세요.' },
  ...
  { id: 'au05', brand: '아우디', model: 'A8',       slug: 'audi-a8',       category: '세단', segment: '대형 세단',         fuel: '가솔린',     imageKey: 'audi-a8',       trims: ['50 TDI Quattro Premium', 'L 55 TFSI Quattro Premium'], seoTitle: '아우디 A8 장기렌트 | 월 납부금 비교', seoDescription: '아우디 A8 장기렌터카 견적. 플래그십 대형 세단 장기렌트 조건을 비교하세요.' },
  { id: 'au06', brand: '아우디', model: 'Q3',       slug: 'audi-q3',       category: 'SUV', segment: '소형 SUV',           fuel: '가솔린/디젤', imageKey: 'audi-q3',       trims: ['35 TDI', '40 TFSI Quattro', '35 TDI Premium', '40 TFSI Quattro Premium'], seoTitle: '아우디 Q3 장기렌트 | 월 납부금 비교', seoDescription: '아우디 Q3 장기렌터카 견적. 프리미엄 소형 SUV 장기렌트 조건을 비교하세요.' },
  { id: 'au07', brand: '아우디', model: 'Q4 e-tron', slug: 'audi-q4-etron', category: 'EV', segment: 'EV 소형 SUV',        fuel: '전기',       imageKey: 'audi-q4-etron', trims: ['e-tron 45', 'e-tron 45 Premium'], seoTitle: '아우디 Q4 e-tron 장기렌트 | 월 납부금 비교', seoDescription: '아우디 Q4 e-tron 전기차 장기렌터카 견적. 프리미엄 EV SUV 장기렌트 조건 비교.' },
  { id: 'au08', brand: '아우디', model: 'Q5',       slug: 'audi-q5',       category: 'SUV', segment: '중형 SUV',           fuel: '가솔린/디젤', imageKey: 'audi-q5',       trims: ['40 TFSI Quattro Advanced', '40 TDI Quattro Advanced', '40 TFSI Quattro S-line'], seoTitle: '아우디 Q5 장기렌트 | 월 납부금 비교', seoDescription: '아우디 Q5 장기렌터카 견적. 인기 프리미엄 중형 SUV 장기렌트 조건을 비교하세요.' },
  { id: 'au09', brand: '아우디', model: 'Q6 e-tron', slug: 'audi-q6-etron', category: 'EV', segment: 'EV 중형 SUV',        fuel: '전기',       imageKey: 'audi-q6-etron', trims: ['Performance', 'Performance premium', 'Quattro premium'], seoTitle: '아우디 Q6 e-tron 장기렌트 | 월 납부금 비교', seoDescription: '아우디 Q6 e-tron 전기차 장기렌터카 견적. 신형 프리미엄 EV 중형 SUV 장기렌트.' },
  { id: 'au10', brand: '아우디', model: 'Q7',       slug: 'audi-q7',       category: 'SUV', segment: '대형 SUV',           fuel: '가솔린/디젤', imageKey: 'audi-q7',       trims: ['50 TDI Quattro', '55 TFSI Quattro', '50 TDI Quattro Premium', '55 TFSI Quattro Premium'], seoTitle: '아우디 Q7 장기렌트 | 월 납부금 비교', seoDescription: '아우디 Q7 장기렌터카 견적. 7인승 대형 프리미엄 SUV 장기렌트 조건을 비교하세요.' },
  ...
  { id: 'au13', brand: '아우디', model: 'RS3',      slug: 'audi-rs3',      category: '세단', segment: '고성능 세단',       fuel: '가솔린',     imageKey: 'audi-rs3',      trims: ['RS3', 'RS3 Carbon Edition'], seoTitle: '아우디 RS3 장기렌트 | 월 납부금 비교', seoDescription: '아우디 RS3 장기렌터카 견적. 최고 성능의 프리미엄 세단 장기렌트 조건을 비교하세요.' },
